...
let p1 = new Product("ô tô", "1", "Toyota", "Nguyên", "43A-12345", "Đen", "2024", "KH123456", "1111111");
let p2 = new Product("ô tô", "2", "Honda", "Nguyên", "43A-12345", "Vàng", "2024", "KH123456", "1111111");
let p3 = new Product("ô tô", "3", "Mazda", "Nguyên", "43A-12345", "Đỏ", "2024", "KH123456", "1111111");
let p4 = new Product("ô tô", "4", "Buggati", "Nguyên", "43A-12345", "Xanh", "2024", "KH123456", "1111111");
myCaseStudy.addCar(p1);
myCaseStudy.addCar(p2);
myCaseStudy.addCar(p3);
myCaseStudy.addCar(p4);
...
function clearForm() {
    document.getElementById("loaiXe").value = "fffff";
